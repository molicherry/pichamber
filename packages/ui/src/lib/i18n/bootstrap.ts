...
const FR_MESSAGES: BootstrapMessages = {
  startingApi: 'Démarrage de l’API pi…',
  ...
  initialDataLoadFailed: 'pi est connecté, mais le chargement initial des données a échoué.',
  cliNotFound: 'L’interface en ligne de commande pi est introuvable. Veuillez l’installer d’abord.',
...
const ZH_TW_MESSAGES: BootstrapMessages = {
  ...
  disconnected: '已中斷連線',
  reconnecting: '正在重新連線…',
  initialDataLoadFailed: 'pi 已連線，但初始資料載入失敗。',
  cliNotFound: '找不到 pi CLI。請先安裝。',
  providersReady: '✓ 提供者',
...
const UK_MESSAGES: BootstrapMessages = {
  ...
  initialDataLoadFailed: 'pi підключено, але початкове завантаження даних не вдалося.',
  cliNotFound: 'pi CLI не знайдено. Спершу встановіть його.',
...
const ES_MESSAGES: BootstrapMessages = {
  startingApi: 'Iniciando la API de pi…',
  ...
  initialDataLoadFailed: 'pi se conectó, pero falló la carga inicial de datos.',
  cliNotFound: 'No se encontró pi CLI. Instálalo primero.',
...
const PT_BR_MESSAGES: BootstrapMessages = {
  startingApi: 'Iniciando a API do pi…',
  initializing: 'Inicializando…',
  connecting: 'Conectando…',
  connected: 'Conectado!',
  ...
  disconnected: 'Desconectado',
  reconnecting: 'Reconectando…',
  initialDataLoadFailed: 'pi conectado, mas o carregamento inicial dos dados falhou.',
  cliNotFound: 'pi CLI não encontrado. Instale-o primeiro.',
...
const KO_MESSAGES: BootstrapMessages = {
  ...
  initialDataLoadFailed: 'pi에 연결되었지만 초기 데이터 로드에 실패했습니다.',
  cliNotFound: 'pi CLI를 찾을 수 없습니다. 먼저 설치하세요.',
  providersReady: '✓ 공급자',
...
const PL_MESSAGES: BootstrapMessages = {
  startingApi: 'Uruchamianie API pi…',
  ...
  initialDataLoadFailed: 'pi połączony, ale początkowe ładowanie danych nie powiodło się.',
  cliNotFound: 'Nie znaleziono pi CLI. Najpierw go zainstaluj.',
...
const JA_MESSAGES: BootstrapMessages = {
  ...
  reconnecting: '再接続中…',
  initialDataLoadFailed: 'pi に接続しましたが、初期データの読み込みに失敗しました。',
  cliNotFound: 'pi CLI が見つかりません。先にインストールしてください。',
...
const DE_MESSAGES: BootstrapMessages = {
  startingApi: 'pi API wird gestartet…',
  ...
  initialDataLoadFailed: 'pi ist verbunden, aber die Anfangsdaten konnten nicht geladen werden.',
  cliNotFound: 'pi CLI wurde nicht gefunden. Installieren Sie es zuerst.',
