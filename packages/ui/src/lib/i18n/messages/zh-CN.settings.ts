...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'pi Go 用量跟踪',
  'settings.providers.page.openCodeGo.description': '连接 pi Go 控制面板以显示滚动、每周和每月配额。',
  ...
  'settings.providers.page.openCodeGo.help': '从控制面板网址复制工作区 ID，并从浏览器开发者工具复制 auth Cookie。pichamber 绝不会扫描浏览器 Cookie 存储。',
  ...
  'settings.providers.page.openCodeGo.saveFailed': '无法验证 pi Go 凭据。',
  'settings.providers.page.openCodeGo.valid': 'pi Go 凭据有效。',
  'settings.providers.page.openCodeGo.invalid': 'pi Go 凭据无效或已过期。',
  'settings.providers.page.openCodeGo.deleted': '已删除 pi Go 凭据。',
  'settings.providers.page.openCodeGo.deleteFailed': '无法删除 pi Go 凭据。',
  ...
  'settings.window.description': 'pichamber 设置窗口。',
  ...
  'settings.view.actions.reloadOpenCode': '重新加载 pi',
  'settings.view.actions.reloadOpenCodeTooltip': '重启 pi 并重新加载其配置。',

  'settings.view.actions.applyAndRestartOpenCode': '应用并重启',
  'settings.view.actions.applyAndRestartOpenCodeTooltipSingle': '应用 1 项待处理的配置更改并重启 pi。',
  'settings.view.actions.applyAndRestartOpenCodeTooltipPlural': '应用 {count} 项待处理的配置更改并重启 pi。',
  'settings.view.pendingRestart.applying': '正在重启…',
  'settings.view.pendingRestart.applied': '已使用待处理的配置更改重启 pi。',
  'settings.view.pendingRestart.applyFailed': '应用配置更改失败。',
  'settings.view.pendingRestart.manualRestartRequired': '已保存到磁盘。请重启已连接的 pi 服务器以应用更改。',
  'settings.view.pendingRestart.saved': '已保存。请重启 pi 以应用。',

  'settings.view.pendingRestart.confirm.title': '应用并重启？',
  'settings.view.pendingRestart.confirm.description': '重启 pi 将停止所有正在运行的聊天。已保存的配置更改将在重启后生效。',
  ...
  'settings.page.appearance.description': '自定义 pichamber 的外观与体验。',
  ...
  'settings.remoteInstances.direct.title': '其他 pichamber 服务器',
  'settings.remoteInstances.direct.description': '此应用可切换到的服务器。从另一台服务器导入配对链接，或通过地址添加。',
  'settings.remoteInstances.direct.addDialog.description': '通过 URL 添加另一个 pichamber 服务器。适用于服务器已在运行且你拥有连接令牌的情况。',
  ...
  'settings.remoteInstances.clientAuth.description': '创建安全链接或令牌，让 pichamber Desktop 可以连接到此服务器。',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '用另一台设备上的 pichamber 应用扫描。一次性使用且会过期。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '在家和外出都可用。外出时流量经由 pichamber Private Relay(端到端加密隧道)传输，无需配置。',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '用其他设备上的 pichamber 应用扫描此二维码。',
  ...
  'settings.remoteInstances.page.field.modeHint': '选择是由 pichamber 为你启动服务器，还是连接到已在运行的服务器。',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'pichamber 在远程机器上使用的端口。留空则自动选择。',
  ...
  'settings.openchamber.about.title': '关于 pichamber',
  'settings.openchamber.about.field.version': '版本',
  'settings.openchamber.about.field.openCodeVersion': 'pi 版本',
  ...
  'settings.agents.page.toast.savedManualRestart': '已保存到磁盘。请重启已连接的 pi 服务器以应用更改。',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': '权限已保存 — 重启 pi 服务器后生效',
  ...
  'settings.behavior.page.warning.description': '此处所做的更改会更新 {path}。当项目级 AGENTS.md 存在时，pi 也会包含它。',
  ...
  'settings.behavior.page.systemPromptOptimization.enableAria': '优化 pi 系统提示词大小',
  'settings.behavior.page.systemPromptOptimization.info': '预计可将 build 和 plan 代理的系统提示词缩减约 40%，其他代理不会改变。这可能会移除覆盖 build 或 plan 的自定义定义，因此此类工作流请勿启用。重启 pi 后应用更改。',
  'settings.behavior.page.systemPromptOptimization.restarting': '正在重启 pi 以应用系统提示词优化…',
  ...
  'settings.skills.location.option.userOpencode.label': '用户 / pi',
  'settings.skills.location.option.userOpencode.description': '全局 pi 配置位置',
  'settings.skills.location.option.projectOpencode.label': '项目 / pi',
  ...
  'settings.skills.catalog.add.descriptionPrefix': '将 Git 仓库添加为新的目录来源。pichamber 会扫描其中包含',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 pichamber',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 pichamber',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 pichamber',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 pichamber',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，pichamber 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 pichamber 关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '关闭主窗口时，让 pichamber 继续在系统托盘中运行；最小化仍会将窗口保留在任务栏。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'pichamber 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'pichamber 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'pichamber 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.openchamber.tools.title': 'pichamber 工具',
  'settings.openchamber.tools.field.agentControlTool': '智能体控制工具',
  'settings.openchamber.tools.field.agentControlToolAria': '启用智能体控制工具',
  'settings.openchamber.tools.field.agentControlToolInfo': '让智能体在聊天中编排你的工作：创建会话和 worktree、将提示委派给其他智能体、管理计划任务。会为每个会话添加少量工具说明。在 pi 重启后生效。',
  'settings.openchamber.tools.field.agentWebTool': 'pichamber Web 工具',
  'settings.openchamber.tools.field.agentWebToolAria': '启用 pichamber Web 工具',
  'settings.openchamber.tools.field.agentWebToolInfo': '让智能体在 pichamber 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 pi 重启后生效。',
  'settings.openchamber.tools.field.agentMemoryTool': '智能体记忆工具',
  'settings.openchamber.tools.field.agentMemoryToolAria': '智能体记忆工具',
  'settings.openchamber.tools.field.agentMemoryToolInfo': '让智能体把学到的内容跨会话保留下来，分为两个存储：关于你的事实，以及关于每个项目的事实。会话会收到已存条目的标题，智能体可在相关时读取具体内容。关闭后将同时移除该工具、记忆标签页和会话索引。重启 pi 后生效。',
  'settings.openchamber.opencodeCli.tooltipPrefix': '可选的',
  'settings.openchamber.opencodeCli.tooltipSuffix': '二进制绝对路径。',
  'settings.openchamber.opencodeCli.field.binaryPath': 'pi 可执行文件路径',
  'settings.openchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openchamber.opencodeCli.field.showUpdateNotifications': '显示 pi 更新通知',
  'settings.openchamber.opencodeCli.field.showUpdateNotificationsAria': '显示 pi 更新通知',
  'settings.openchamber.opencodeCli.actions.browseAria': '浏览 pi 可执行文件路径',
  'settings.openchamber.opencodeCli.actions.browse': '浏览',
  'settings.openchamber.opencodeCli.actions.saveAndReload': '保存并重载',
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': '正在重启 pi…',
  'settings.openchamber.opencodeCli.dialog.selectBinaryTitle': '选择 pi 可执行文件',
  ...
  'settings.remoteInstances.page.description': '通过 SSH 连接到另一台机器，并在那里打开 pichamber。',
  ...
  'settings.remoteInstances.page.section.remoteServer': '远程机器上的 pichamber',
  'settings.remoteInstances.page.section.remoteServerDescription': '选择 SSH 连接后 pichamber 的运行方式。',
  'settings.remoteInstances.page.section.mainTunnel': '从这台电脑访问',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'pichamber 运行在远程机器上。这里的设置只决定这台电脑上通过 SSH 隧道通向它的地址。',
  'settings.remoteInstances.page.section.authentication': '认证',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH 和远程 pichamber UI 的可选凭据。',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '当此应用为你启动 pichamber 时，如何将它放到远程机器上。',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '请先指定远程端口。在“已在运行”模式下，pichamber 需要知道服务器监听哪个端口。',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '也允许远程机器所在网络中的其他设备不经 SSH 隧道直接打开这个 pichamber。必须设置界面密码。',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '该网络中的任何人都能访问远程 pichamber，保护它的只有下面的界面密码。',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '请先设置界面密码。没有密码时，远程 pichamber 会对该网络中的所有设备开放。',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '用于保护远程 pichamber 界面的密码。pichamber 会把它设置到为你启动的服务器上。',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '远程机器上已在运行的 pichamber 服务器的密码，用于登录。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 pichamber',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 pichamber',
  ...
  'settings.providers.sidebar.empty.description': '请检查 pi 配置',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': '请检查 pi 配置',
  ...
  'settings.providers.page.custom.description': '通过指定基础 URL、凭据、模型列表和支持的 API 协议添加提供商。会写入 pi 配置以供聊天使用。',
  ...
  'settings.providers.page.custom.field.providerID.info': '小写字母、数字、连字符和下划线。用作 pi 提供商 ID。',
  ...
  'settings.providers.page.custom.field.apiKey.info': '保存在 pi 认证中，而非 pichamber。使用 {env:VAR_NAME} 可从环境变量读取密钥。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 pi，不会被 pichamber 存储。',
  ...
  'settings.mcp.page.status.description.awaitingRestart': '该服务器已保存但尚未生效。使用 Apply & Restart 让 pi 加载它——之后即可进行连接和授权。',
  'settings.mcp.page.status.description.connected': '已连接，pi 可发现工具和资源。',
  'settings.mcp.page.status.description.failedDefault': 'pi 无法连接到此 MCP 服务器。',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': '正在等待 pi 识别浏览器中已完成的授权流程...',
  ...
  'settings.mcp.page.advanced.timeoutHint': '留空以使用 pi 的默认 MCP 超时。',
  ...
  'settings.mcp.page.advanced.oauthHint': '将这些字段留空可让 pi 从 MCP 服务器推断 OAuth 设置。',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'pi 需要重新加载。',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP 服务器已创建，但 pi 重载失败。',
  'settings.mcp.page.toast.savedReloadFailed': '已保存，但 pi 重载失败。',
  'settings.mcp.page.toast.retryRefreshHint': '请重试刷新或重新打开设置后再授权该服务器。',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP 服务器已创建。pi 正在重载…',
  'settings.mcp.page.toast.savedReloading': '已保存。pi 正在重载…',
  'settings.mcp.page.toast.saveFailed': '保存失败',
  'settings.mcp.page.toast.unexpectedError': '发生错误',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '“{name}”已删除，但 pi 重载失败',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': '保存浏览器回调 URL 后 pi 重载失败',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'pi 智能体默认值',
  ...
  'settings.github.page.flow.title': '授权 pichamber',
  ...
  'settings.github.page.ghCli.fallbackDescription': '在 pichamber 认证被移除时可作为备用',
  ...
  'settings.notifications.page.testNotification.body': '这是来自 pichamber 的测试通知。',
  ...
  'settings.voice.page.tooltip.sttLocal': '在 pichamber 服务器上本地转写。模型自动下载，无需 API 密钥。',
  'settings.voice.page.tooltip.localTts': '在 pichamber 服务器上本地合成语音（Kokoro，英语）。模型自动下载，无需 API 密钥。',
