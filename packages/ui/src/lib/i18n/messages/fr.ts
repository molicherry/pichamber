...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez pichamber pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'pichamber installé',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de pichamber',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur pichamber auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans pichamber. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version pichamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Version pi {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état pichamber, l’état de santé pi, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans pichamber',
  ...
  'header.actions.openAppMenu': 'Menu de pichamber',
  'header.actions.openAppMenuAria': 'Ouvrir le menu pichamber',
  ...
  'chat.emptyState.opencodeUnreachable': 'pi n\'est pas accessible',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'pi a redémarré alors qu’une réponse était encore en cours. Envoyez un message pour continuer.',
  ...
  'commandPalette.item.showOpenCodeStatus': 'Afficher le statut pi',
  ...
  'openCodeStatusDialog.description': 'Inspectez l’état et les diagnostics actuels du pi.',
  ...
  'mcpDropdown.empty.configureInConfig': 'Configurez les serveurs MCP dans la configuration pi.',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez pichamber depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez pichamber',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs pichamber locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution pichamber.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur pichamber',
  ...
  'onboarding.localSetup.title': 'Configuration de pi',
  'onboarding.localSetup.description': 'Installez pi CLI pour continuer.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Sélectionnez le binaire pi',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI n’est pas encore prêt. Veuillez confirmer que l\'installation est terminée et réessayer.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si pichamber ne détecte pas automatiquement pi, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'pi est le cœur de pichamber — installez-le pour commencer.',
  'onboarding.localSetup.docs.windows': 'Documents pi Windows + WSL',
  'onboarding.localSetup.docs.default': 'Documents pi',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Cliquez pour vérifier si pi CLI est disponible. En cas de succès, vous entrerez automatiquement dans l\'écran principal.',
  'onboarding.localSetup.status.watching': 'En attendant pi',
  'onboarding.localSetup.status.autoContinue': 'Nous continuerons automatiquement une fois qu’il sera détecté.',
  'onboarding.localSetup.field.alreadyInstalled': 'Déjà installé ? Définissez le chemin pi CLI :',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres pichamber et recharge la configuration pi.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'Sous Windows, installez et exécutez pi dans WSL pour une meilleure compatibilité.',
  ...
  'onboarding.localSetup.hint.ensurePath': 'Déjà installé ? Assurez-vous qu\'pi est dans votre PATH.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur pichamber auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur pichamber ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas pichamber. Vérifiez que l\'adresse pointe vers un serveur pichamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'pi local indisponible',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLI n\'a pas pu être démarré ou n\'est pas installé. Installez pi ou connectez-vous plutôt à un serveur distant.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas pichamber. Vérifiez que l\'adresse pointe vers un serveur pichamber.',
  ...
  'startup.initRecovery.description': 'pichamber n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de pichamber...',
  ...
  'mobileUpdate.toast.available.title': 'Mise à jour pichamber disponible',
  ...
  'opencodeUpdate.toast.actions.reload': 'Recharger pi',
  'opencodeUpdate.toast.upgrading.title': 'Mise à jour de pi...',
  'opencodeUpdate.toast.upgrading.description': 'Gardez pichamber ouvert.',
  'opencodeUpdate.toast.updated.title': 'pi mis à jour',
  ...
  'opencodeUpdate.toast.failed.title': 'Impossible de mettre à jour pi',
  'opencodeUpdate.toast.failed.description': 'La mise à niveau du pi a échoué.',
  'opencodeUpdate.toast.reload.message': 'Redémarrage de pi...',
  ...
  'openChamberLogo.aria.logo': 'Logo pichamber',
  ...
  'mobile.connect.welcome.title': 'Se connecter à pichamber',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe pichamber',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion pichamber.',
  ...
  'mobile.connect.relay.badge': 'via pichamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur pichamber.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve pichamber, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge pichamber. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à pichamber — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’pichamber. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute pichamber mais n’est pas compatible avec cette version de l’application. Mettez pichamber à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur pichamber à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez pichamber à jour sur le serveur, puis réessayez.',
