...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala pichamber para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "pichamber se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a pichamber",
  ...
  "mobile.connect.password.placeholder": "Contraseña de pichamber",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de pichamber.",
  ...
  "mobile.connect.relay.badge": "a través de pichamber Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de pichamber.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de pichamber",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de pichamber al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está pichamber y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja pichamber. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a pichamber: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en pichamber. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "pichamber necesita acceso a esta carpeta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de pichamber {version}",
  "aboutDialog.openCodeVersionLabel": "Versión de pi {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de pichamber, el estado de pi, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por pichamber de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de pichamber",
  "header.actions.openAppMenuAria": "Abrir menú de pichamber",
  ...
  "chat.toast.opencodeRestartInterrupted.description": "pi se reinició mientras aún se estaba generando una respuesta. Envía un mensaje para continuar.",
  ...
  "commandPalette.item.showOpenCodeStatus": "Mostrar estado de pi",
  ...
  "openCodeStatusDialog.title": "Estado de pi",
  "openCodeStatusDialog.description": "Inspecciona el estado actual de pi y diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres pichamber desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear pichamber",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de pichamber",
  ...
  "multiRun.window.description": "Ventana de pichamber Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a pichamber",
  ...
  "onboarding.localSetup.title": "Configuración de pi",
  "onboarding.localSetup.description": "Instala la CLI de pi para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de opencode",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de pi aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala pi con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si pichamber no detecta pi automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "pi es el corazón de pichamber. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de pi",
  "onboarding.localSetup.docs.default": "Documentación de pi",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de pi está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando pi",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de pi:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de pichamber y recarga la configuración de pi.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta pi de forma nativa.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de pichamber para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor pichamber o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de pichamber. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta pichamber pero no es compatible con esta versión de la app. Actualiza pichamber en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando pichamber. Verifica que la dirección apunte a un servidor pichamber.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "pi Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de pi no pudo iniciarse o no está instalado. Instala pi o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando pichamber. Verifica que la dirección apunte a un servidor pichamber.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor pichamber en \"{host}\" no es compatible con esta versión de la app. Actualiza pichamber en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "pichamber no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando pichamber...",
  ...
  "mobileUpdate.toast.available.title": "Actualización de pichamber disponible",
  ...
  "opencodeUpdate.toast.available.title": "Actualización de pi",
  ...
  "opencodeUpdate.toast.actions.reload": "Recargar pi",
  "opencodeUpdate.toast.upgrading.title": "Actualizando pi...",
  "opencodeUpdate.toast.upgrading.description": "Mantén pichamber abierto.",
  "opencodeUpdate.toast.updated.title": "pi actualizado",
  ...
  "opencodeUpdate.toast.failed.title": "No se pudo actualizar pi",
  "opencodeUpdate.toast.failed.description": "La actualización de pi falló.",
  "opencodeUpdate.toast.reload.message": "Reiniciando pi...",
  ...
  "openChamberLogo.aria.logo": "Logo de pichamber",
