...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install pichamber for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'pichamber installed',
  ...
  'mobile.connect.welcome.title': 'Connect to pichamber',
  ...
  'mobile.connect.password.placeholder': 'pichamber password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an pichamber connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that pichamber server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About pichamber',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The pichamber server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine pichamber is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting pichamber. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to pichamber — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in pichamber. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes pichamber state, pi health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate pichamber efficiently',
  ...
  'header.actions.openAppMenu': 'pichamber menu',
  'header.actions.openAppMenuAria': 'Open pichamber menu',
  ...
  'chat.emptyState.opencodeUnreachable': 'pi is not reachable',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'pi restarted while a response was still running. Send a message to continue.',
  ...
  'commandPalette.item.showOpenCodeStatus': 'Show pi status',
  ...
  'openCodeStatusDialog.description': 'Inspect current pi status and diagnostics.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening pichamber from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock pichamber',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote pichamber servers',
  ...
  'multiRun.window.description': 'pichamber Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to pichamber',
  ...
  'onboarding.localSetup.title': 'Setting Up pi',
  'onboarding.localSetup.description': 'Install pi CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select opencode binary',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install pi with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If pichamber does not detect pi automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'pi is the heart of pichamber — install it to get started.',
  'onboarding.localSetup.docs.windows': 'pi docs',
  'onboarding.localSetup.docs.default': 'pi docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if pi CLI is available. If successful, you\'ll automatically enter the main screen.',
  ...
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the pi CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to pichamber settings and reloads pi configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run pi natively.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an pichamber server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an pichamber server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different pichamber version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running pichamber but is not compatible with this app version. Update pichamber on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running pichamber. Verify the address points to an pichamber server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local pi Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLI could not be started or is not installed. Install pi or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running pichamber. Verify the address points to an pichamber server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The pichamber server at "{host}" is not compatible with this app version. Update pichamber on the server, then try again.',
  ...
  'updateDialog.header.updating': 'Updating pichamber...',
  ...
  'opencodeUpdate.toast.actions.reload': 'Reload pi',
  'opencodeUpdate.toast.upgrading.title': 'Updating pi...',
  'opencodeUpdate.toast.upgrading.description': 'Keep pichamber open.',
  'opencodeUpdate.toast.updated.title': 'pi updated',
  ...
  'opencodeUpdate.toast.failed.title': 'Could not update pi',
  'opencodeUpdate.toast.failed.description': 'The pi upgrade failed.',
  'opencodeUpdate.toast.reload.message': 'Restarting pi...',
