...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'Monitoramento de uso do pi Go',
  'settings.providers.page.openCodeGo.description': 'Conecte o painel do pi Go para exibir as cotas móvel, semanal e mensal.',
  ...
  'settings.providers.page.openCodeGo.help': 'Copie o ID da URL do painel e o cookie auth das ferramentas do navegador. O pichamber nunca examina os cookies do navegador.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Não foi possível validar as credenciais do pi Go.',
  'settings.providers.page.openCodeGo.valid': 'As credenciais do pi Go são válidas.',
  'settings.providers.page.openCodeGo.invalid': 'As credenciais do pi Go são inválidas ou expiraram.',
  'settings.providers.page.openCodeGo.deleted': 'Credenciais do pi Go excluídas.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Não foi possível excluir as credenciais do pi Go.',
  ...
  "settings.window.description": "Janela de configurações do pichamber.",
  ...
  "settings.view.actions.reloadOpenCode": "Recarregar pi",
  "settings.view.actions.reloadOpenCodeTooltip": "Reiniciar pi e recarregar suas configurações.",

  "settings.view.actions.applyAndRestartOpenCode": "Aplicar e reiniciar",
  "settings.view.actions.applyAndRestartOpenCodeTooltipSingle": "Aplicar 1 alteração de configuração pendente e reiniciar o pi.",
  "settings.view.actions.applyAndRestartOpenCodeTooltipPlural": "Aplicar {count} alterações de configuração pendentes e reiniciar o pi.",
  "settings.view.pendingRestart.applying": "Reiniciando…",
  "settings.view.pendingRestart.applied": "pi reiniciado com as alterações de configuração pendentes.",
  "settings.view.pendingRestart.applyFailed": "Falha ao aplicar as alterações de configuração.",
  "settings.view.pendingRestart.manualRestartRequired": "Salvo no disco. Reinicie o servidor pi conectado para aplicar as alterações.",
  "settings.view.pendingRestart.saved": "Salvo. Reinicie o pi para aplicar.",

  "settings.view.pendingRestart.confirm.title": "Aplicar e reiniciar?",
  "settings.view.pendingRestart.confirm.description": "Reiniciar o pi interromperá quaisquer chats em execução. As alterações de configuração salvas entrarão em vigor após a reinicialização.",
  ...
  "settings.page.appearance.description": "Personalize a aparência e a sensação do pichamber.",
  ...
  "settings.remoteInstances.direct.title": "Outros servidores pichamber",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Adicione outro servidor pichamber por URL. Use isto quando o servidor já estiver em execução e você tiver um token de conexão.",
  ...
  "settings.remoteInstances.direct.import.description": "Cole um link de conexão de outro servidor pichamber.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Link de conexão do pichamber inválido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crie um link ou token seguro para que o pichamber Desktop possa se conectar a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escaneie com o app pichamber no seu outro dispositivo. É de uso único e expira.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona em casa e fora. Fora de casa o tráfego passa pelo pichamber Private Relay, um túnel criptografado de ponta a ponta. Sem configuração.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escaneie este código QR com o app pichamber no seu outro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Escolha se o pichamber deve iniciar o servidor para você ou se conectar a um que já está em execução.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Porta que o pichamber usa na máquina remota. Deixe vazio para escolher automaticamente.",
  ...
  "settings.openchamber.about.title": "Sobre o pichamber",
  "settings.openchamber.about.field.version": "Versão",
  "settings.openchamber.about.field.openCodeVersion": "Versão do pi",
  ...
  "settings.agents.page.toast.savedManualRestart": "Salvo no disco. Reinicie o servidor pi conectado para aplicar as alterações.",
  ...
  "settings.agents.page.permissionsEditor.toast.savedRestartRequired": "Permissões salvas — reinicie o servidor pi para aplicar",
  ...
  "settings.behavior.page.warning.description": "As alterações feitas aqui atualizam {path}. O pi também inclui qualquer AGENTS.md a nível de projeto quando existir.",
  ...
  "settings.behavior.page.systemPromptOptimization.enableAria": "Otimizar o tamanho do prompt do sistema do pi",
  "settings.behavior.page.systemPromptOptimization.info": "Reduz o prompt do sistema em cerca de 40% para os agentes build e plan. Os outros agentes não são alterados. Isso pode remover definições personalizadas que substituem build ou plan, portanto não ative nesses fluxos de trabalho. A alteração é aplicada após reiniciar o pi.",
  "settings.behavior.page.systemPromptOptimization.restarting": "Reiniciando o pi para aplicar a otimização do prompt do sistema…",
  ...
  "settings.skills.location.option.userOpencode.label": "Usuário / pi",
  "settings.skills.location.option.userOpencode.description": "Localização global das configurações do pi",
  "settings.skills.location.option.projectOpencode.label": "Projeto / pi",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Adicione um repositório Git como nova origem de catálogo. O pichamber escaneará para encontrar pastas que contenham",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o pichamber ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o pichamber ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o pichamber na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o pichamber na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o pichamber não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Fechar o pichamber na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o pichamber em execução na bandeja do sistema quando a janela principal é fechada. Ao minimizar, a janela permanece na barra de tarefas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o pichamber estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o pichamber estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O pichamber pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.openchamber.opencodeCli.title": "CLI do pi",
  "settings.openchamber.tools.title": "Ferramentas do pichamber",
  ...
  "settings.openchamber.tools.field.agentControlToolInfo": "Permita que agentes orquestrem seu trabalho pelo chat: criar sessões e worktrees, delegar prompts a outros agentes e gerenciar tarefas agendadas. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após reiniciar o pi.",
  "settings.openchamber.tools.field.agentWebTool": "Ferramenta pichamber Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Ativar a ferramenta pichamber Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permita que agentes vejam a página no painel de navegador do pichamber e interajam com ela: abrir uma URL, ler o conteúdo, clicar, digitar, rolar e alternar entre layout móvel e desktop. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após reiniciar o pi.",
  ...
  "settings.openchamber.opencodeCli.field.binaryPath": "Caminho do executável do pi",
  "settings.openchamber.opencodeCli.field.binaryPathPlaceholder": "/Users/you/.bun/bin/opencode",
  "settings.openchamber.opencodeCli.field.showUpdateNotifications": "Mostrar notificações de atualização do pi",
  "settings.openchamber.opencodeCli.field.showUpdateNotificationsAria": "Mostrar notificações de atualização do pi",
  "settings.openchamber.opencodeCli.actions.browseAria": "Buscar caminho do executável do pi",
  ...
  "settings.remoteInstances.page.description": "Conecte-se a outra máquina por SSH e abra o pichamber lá.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "pichamber na máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Escolha como o pichamber deve rodar depois que o SSH conectar.",
  "settings.remoteInstances.page.section.mainTunnel": "Acesso a partir deste computador",
  "settings.remoteInstances.page.section.mainTunnelDescription": "O pichamber roda na máquina remota. Estas opções controlam apenas o endereço neste computador que leva até ela pelo túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticação",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciais opcionais para SSH e para a interface de usuário do pichamber remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Como o pichamber deve ser colocado na máquina remota quando este app o inicia para você.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Defina primeiro uma porta remota. No modo “Já em execução”, o pichamber precisa saber em qual porta o servidor escuta.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir que outros dispositivos da rede da máquina remota abram este pichamber diretamente, sem o túnel SSH. É obrigatória uma senha da interface.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Qualquer pessoa nessa rede alcança o pichamber remoto. Só a senha da interface abaixo o protege.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Defina primeiro uma senha da interface. Sem ela, o pichamber remoto ficaria aberto a todos os dispositivos daquela rede.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Senha que protegerá a interface remota do pichamber. O pichamber a define no servidor que inicia para você.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Senha do servidor pichamber que já está em execução na máquina remota, usada para entrar nele.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Atualizando pichamber",
  ...
  "settings.providers.sidebar.empty.description": "Revise seu configurações do pi",
  ...
  "settings.providers.page.empty.checkOpenCodeConfiguration": "Revise seu configurações do pi",
  ...
  "settings.providers.page.custom.description": "Adicione um provedor com URL base, credenciais, lista de modelos e protocolo de API compatível. Ele é salvo na configuração do pi para uso no chat.",
  ...
  "settings.providers.page.custom.field.providerID.info": "Letras minúsculas, números, hífens e sublinhados. Usado como ID de provedor do pi.",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do pi, não pelo pichamber. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao pi e nunca são armazenadas no pichamber.",
  ...
  "settings.mcp.page.status.description.awaitingRestart": "Este servidor foi salvo, mas ainda não aplicado. Use Apply & Restart para carregá-lo no pi — depois disso, conexão e autorização ficam disponíveis.",
  "settings.mcp.page.status.description.connected": "Conectado e pronto para que pi descubra ferramentas e recursos.",
  "settings.mcp.page.status.description.failedDefault": "pi não conseguiu acessar este servidor MCP.",
  ...
  "settings.mcp.page.auth.waitingForOpenCode": "Aguardando pi observar o fluxo de autorização concluído pelo navegador...",
  ...
  "settings.mcp.page.advanced.timeoutHint": "Deixe em branco para usar o tempo limite padrão do pi para MCP.",
  ...
  "settings.mcp.page.advanced.oauthHint": "Deixe estes campos em branco para que pi infira automaticamente a configuração de OAuth do servidor MCP.",
  ...
  "settings.mcp.page.deleteDialog.descriptionSuffix": "pi necesitará recarregar.",
  ...
  "settings.mcp.page.toast.serverCreatedReloadFailed": "Servidor MCP criado, mas pi não pôde recarregar.",
  "settings.mcp.page.toast.savedReloadFailed": "Salvo, mas pi não pôde recarregar.",
  "settings.mcp.page.toast.retryRefreshHint": "Atualize novamente ou reabra Configurações antes de autorizar este servidor.",
  "settings.mcp.page.toast.serverCreatedReloading": "Servidor MCP criado. pi recarregando…",
  "settings.mcp.page.toast.savedReloading": "Salvo. pi recarregando…",
  "settings.mcp.page.toast.saveFailed": "Não foi possível salvar",
  "settings.mcp.page.toast.unexpectedError": "Ocorreu um erro",
  "settings.mcp.page.toast.serverDeletedReloadFailed": "\"{name}\" excluído, mas pi não pôde recarregar",
  ...
  "settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave": "Não foi possível recarregar pi depois de salvar a URL de callback do navegador",
  ...
  "settings.openchamber.defaults.summaryOpenCodeDefault": "Agente pi por padrão",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponível como alternativa se a autenticação do pichamber for removida",
  ...
  "settings.notifications.page.testNotification.body": "Esta é uma notificação de teste do pichamber.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcrição local no servidor do pichamber. Os modelos são baixados automaticamente; não é necessária chave de API.",
  "settings.voice.page.tooltip.localTts": "Síntese local no servidor do pichamber (Kokoro, inglês). O modelo é baixado automaticamente; não é necessária chave de API.",
