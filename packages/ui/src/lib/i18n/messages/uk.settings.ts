...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'Відстеження використання pi Go',
  'settings.providers.page.openCodeGo.description': 'Підключіть панель pi Go, щоб бачити ковзну, тижневу та місячну квоту.',
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. pichamber ніколи не сканує сховище cookie браузера.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Не вдалося перевірити дані pi Go.',
  'settings.providers.page.openCodeGo.valid': 'Дані pi Go дійсні.',
  'settings.providers.page.openCodeGo.invalid': 'Дані pi Go недійсні або протерміновані.',
  'settings.providers.page.openCodeGo.deleted': 'Дані pi Go видалено.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Не вдалося видалити дані pi Go.',
  ...
  "settings.window.description": "Вікно налаштувань pichamber.",
  ...
  "settings.view.actions.reloadOpenCode": "Перезавантажити pi",
  "settings.view.actions.reloadOpenCodeTooltip": "Перезапустити pi і перезавантажити його конфігурацію.",

  "settings.view.actions.applyAndRestartOpenCode": "Застосувати та перезапустити",
  "settings.view.actions.applyAndRestartOpenCodeTooltipSingle": "Застосувати 1 очікувану зміну конфігурації та перезапустити pi.",
  "settings.view.actions.applyAndRestartOpenCodeTooltipPlural": "Застосувати {count} очікуваних змін конфігурації та перезапустити pi.",
  "settings.view.pendingRestart.applying": "Перезапуск…",
  "settings.view.pendingRestart.applied": "pi перезапущено з очікуваними змінами конфігурації.",
  "settings.view.pendingRestart.applyFailed": "Не вдалося застосувати зміни конфігурації.",
  "settings.view.pendingRestart.manualRestartRequired": "Збережено на диску. Перезапустіть підключений сервер pi, щоб застосувати зміни.",
  "settings.view.pendingRestart.saved": "Збережено. Перезапустіть pi, щоб застосувати.",

  "settings.view.pendingRestart.confirm.title": "Застосувати та перезапустити?",
  "settings.view.pendingRestart.confirm.description": "Перезапуск pi зупинить усі активні чати. Збережені зміни конфігурації набудуть чинності після перезапуску.",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття pichamber.",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери pichamber",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер pichamber за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.direct.import.description": "Вставте посилання для підключення з іншого сервера pichamber.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Недійсне посилання підключення pichamber.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб pichamber Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення pichamber",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком pichamber на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через pichamber Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком pichamber на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Виберіть, чи pichamber має запустити сервер для вас, чи підключитися до вже запущеного.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Порт, який pichamber займе на віддаленій машині. Лишіть порожнім, щоб вибрався автоматично.",
  ...
  "settings.openchamber.about.title": "Про pichamber",
  "settings.openchamber.about.field.version": "Версія",
  "settings.openchamber.about.field.openCodeVersion": "Версія pi",
  ...
  "settings.agents.page.toast.savedManualRestart": "Збережено на диск. Перезапустіть підключений сервер pi, щоб застосувати зміни.",
  ...
  "settings.agents.page.permissionsEditor.toast.savedRestartRequired": "Дозволи збережено — перезапустіть сервер pi, щоб застосувати",
  ...
  "settings.behavior.page.warning.description": "Зміни тут оновлюють {path}. pi також додає правила з AGENTS.md на рівні проєкту, якщо вони існують.",
  ...
  "settings.behavior.page.systemPromptOptimization.enableAria": "Оптимізувати розмір системного промпту pi",
  "settings.behavior.page.systemPromptOptimization.info": "Зменшує системний промпт орієнтовно на 40% для агентів build і plan. Інші агенти не змінюються. Це може видалити власні визначення, які перевизначають build або plan, тому не вмикайте цю функцію для таких робочих процесів. Зміна застосовується після перезапуску pi.",
  "settings.behavior.page.systemPromptOptimization.restarting": "Перезапуск pi для застосування оптимізації системного промпту…",
  ...
  "settings.skills.location.option.userOpencode.label": "Користувач / pi",
  "settings.skills.location.option.userOpencode.description": "Розташування глобальної конфігурації pi",
  "settings.skills.location.option.projectOpencode.label": "Проєкт / pi",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. pichamber просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати pichamber під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати pichamber під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати pichamber у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати pichamber у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, pichamber не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати pichamber у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає pichamber запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки pichamber запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки pichamber запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "pichamber попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти pichamber",
  ...
  "settings.openchamber.tools.field.agentControlToolInfo": "Дозвольте агентам оркеструвати вашу роботу з чату: створювати сесії та worktree, делегувати запити іншим агентам і керувати запланованими задачами. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску pi.",
  "settings.openchamber.tools.field.agentWebTool": "Інструмент pichamber Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент pichamber Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Дозвольте агентам переглядати сторінку в панелі браузера pichamber і взаємодіяти з нею: відкривати URL, читати вміст, клікати, вводити текст, гортати та перемикатися між мобільним і десктопним виглядом. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску pi.",
  ...
  "settings.openchamber.opencodeCli.field.binaryPath": "Шлях до бінарного файлу pi",
  "settings.openchamber.opencodeCli.field.binaryPathPlaceholder": "/Users/you/.bun/bin/opencode",
  "settings.openchamber.opencodeCli.field.showUpdateNotifications": "Показувати сповіщення про оновлення pi",
  "settings.openchamber.opencodeCli.field.showUpdateNotificationsAria": "Показувати сповіщення про оновлення pi",
  "settings.openchamber.opencodeCli.actions.browseAria": "Вибрати шлях до виконуваного файла pi",
  ...
  "settings.openchamber.opencodeCli.actions.restartingOpenCode": "Перезапуск pi…",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там pichamber.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "pichamber на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як pichamber має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Доступ із цього комп’ютера",
  "settings.remoteInstances.page.section.mainTunnelDescription": "pichamber працює на віддаленій машині. Ці налаштування керують лише адресою на цьому комп’ютері, яка веде до неї через SSH-тунель.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача pichamber.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити pichamber на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Спершу вкажіть віддалений порт. У режимі «Вже запущено» pichamber має знати, на якому порту слухає сервер.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Дозволити іншим пристроям у мережі віддаленої машини відкривати цей pichamber напряму, без SSH-тунелю. Потрібен пароль UI.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Будь-хто в тій мережі зможе дістатись віддаленого pichamber. Його захищає лише пароль UI нижче.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Спершу задайте пароль UI. Без нього віддалений pichamber буде відкритий для всіх пристроїв у тій мережі.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Пароль, яким буде захищено віддалений інтерфейс pichamber. pichamber задасть його серверу, який запускає для вас.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Пароль сервера pichamber, який уже працює на віддаленій машині, для входу в нього.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення pichamber",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення pichamber",
  ...
  "settings.providers.sidebar.empty.description": "Перевірте свою конфігурацію pi",
  ...
  "settings.providers.page.empty.checkOpenCodeConfiguration": "Перевірте свою конфігурацію pi",
  ...
  "settings.providers.page.custom.description": "Додайте провайдера з базовою URL-адресою, обліковими даними, списком моделей і підтримуваним протоколом API. Зберігається в конфігурації pi для використання в чаті.",
  ...
  "settings.providers.page.custom.field.providerID.info": "Малі літери, цифри, дефіси та підкреслення. Використовується як ID провайдера pi.",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації pi, не pichamber. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до pi і ніколи не зберігаються в pichamber.",
  ...
  "settings.mcp.page.status.description.awaitingRestart": "Сервер збережено, але ще не застосовано. Натисніть Apply & Restart, щоб pi його завантажив — після цього стануть доступні підключення та авторизація.",
  "settings.mcp.page.status.description.connected": "Підключено, pi може відкривати інструменти й ресурси.",
  "settings.mcp.page.status.description.failedDefault": "pi не вдалося отримати доступ до цього сервера MCP.",
  ...
  "settings.mcp.page.auth.waitingForOpenCode": "Очікуємо, поки pi помітить завершення авторизації в браузері...",
  ...
  "settings.mcp.page.advanced.timeoutHint": "Залиште поле порожнім, щоб використовувати тайм-аут pi за замовчуванням MCP.",
  ...
  "settings.mcp.page.advanced.oauthHint": "Залиште ці поля порожніми, щоб дозволити pi виводити налаштування OAuth із сервера MCP.",
  ...
  "settings.mcp.page.deleteDialog.descriptionSuffix": "pi потрібно буде перезавантажити.",
  ...
  "settings.mcp.page.toast.serverCreatedReloadFailed": "Сервер MCP створено, але перезавантаження pi не вдалося.",
  "settings.mcp.page.toast.savedReloadFailed": "Збережено, але pi не вдалося перезавантажити.",
  ...
  "settings.mcp.page.toast.serverCreatedReloading": "MCP сервер створено. pi перезавантажується…",
  "settings.mcp.page.toast.savedReloading": "Збережено. pi перезавантажується…",
  "settings.mcp.page.toast.saveFailed": "Не вдалося зберегти",
  "settings.mcp.page.toast.unexpectedError": "Сталася помилка",
  "settings.mcp.page.toast.serverDeletedReloadFailed": "\"{name}\" видалено, але pi не вдалося перезавантажити",
  ...
  "settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave": "Не вдалося перезавантажити pi після збереження callback URL браузера",
  ...
  "settings.openchamber.defaults.summaryOpenCodeDefault": "Типовий агент pi",
  ...
  "settings.github.page.flow.title": "Авторизувати pichamber",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію pichamber видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від pichamber.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Локальна розшифровка на сервері pichamber. Моделі завантажуються автоматично; ключ API не потрібен.",
  "settings.voice.page.tooltip.localTts": "Локальний синтез на сервері pichamber (Kokoro, англійська). Модель завантажується автоматично; ключ API не потрібен.",
