...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.integrations.thirdParty.info': 'Install a provider plugin, then set up your subscription so pichamber can use it.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Restart pi before setting up this provider.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Could not check npm right now.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'The provider is not available yet. Restart pi and try again.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Remove integration',
    'settings.integrations.thirdParty.dialog.remove.description': 'Remove {name} from your user-wide pi configuration? The provider will no longer load after pi refreshes.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Restart pi for changes to take effect',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor’s generous in-house model limits, now in pichamber.',
  },
  de: {
    ...
    'settings.integrations.thirdParty.info': 'Installiere ein Provider-Plugin und richte dein Abonnement ein, damit pichamber es nutzen kann.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Starte pi neu, bevor du diesen Provider einrichtest.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'npm konnte gerade nicht geprüft werden.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Der Provider ist noch nicht verfügbar. Starte pi neu und versuche es erneut.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Integration entfernen',
    'settings.integrations.thirdParty.dialog.remove.description': '{name} aus deiner benutzerweiten pi-Konfiguration entfernen? Der Provider wird nach der Aktualisierung von pi nicht mehr geladen.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Starte pi neu, damit die Änderungen wirksam werden',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Die großzügigen Limits der Cursor-eigenen Modelle jetzt in pichamber.',
  },
  fr: {
    ...
    'settings.integrations.thirdParty.info': 'Installez un plugin de fournisseur, puis configurez votre abonnement pour qu’pichamber puisse l’utiliser.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Redémarrez pi avant de configurer ce fournisseur.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Impossible de vérifier npm pour le moment.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Le fournisseur n’est pas encore disponible. Redémarrez pi et réessayez.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Supprimer l’intégration',
    'settings.integrations.thirdParty.dialog.remove.description': 'Supprimer {name} de votre configuration pi globale ? Le fournisseur ne sera plus chargé après l’actualisation d’pi.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Redémarrez pi pour que les modifications prennent effet',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Les généreuses limites des modèles internes Cursor, désormais dans pichamber.',
  },
  es: {
    ...
    'settings.integrations.thirdParty.info': 'Instala un plugin de proveedor y configura tu suscripción para que pichamber pueda usarla.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Reinicia pi antes de configurar este proveedor.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'No se pudo comprobar npm ahora mismo.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'El proveedor todavía no está disponible. Reinicia pi e inténtalo de nuevo.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Quitar integración',
    'settings.integrations.thirdParty.dialog.remove.description': '¿Quitar {name} de tu configuración global de pi? El proveedor dejará de cargarse después de actualizar pi.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Reinicia pi para que los cambios surtan efecto',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Usa tu plan Claude Pro/Max: sin claves API ni apps de Claude.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Los generosos límites de los modelos internos de Cursor, ahora en pichamber.',
  },
  ja: {
    ...
    'settings.integrations.thirdParty.info': 'プロバイダープラグインをインストールし、サブスクリプションを設定して pichamber で使えるようにします。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'このプロバイダーを設定する前に pi を再起動してください。',
    'settings.integrations.thirdParty.status.registryUnavailable': '現在 npm を確認できません。',
    'settings.integrations.thirdParty.status.providerUnavailable': 'プロバイダーはまだ利用できません。pi を再起動して再試行してください。',
    'settings.integrations.thirdParty.dialog.remove.title': '連携を削除',
    'settings.integrations.thirdParty.dialog.remove.description': '{name} をユーザー全体の pi 設定から削除しますか？pi の更新後、このプロバイダーは読み込まれなくなります。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '変更を反映するには pi を再起動してください',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Claude Pro/Max プランを利用 — API キーも Claude アプリも不要。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内蔵モデルの余裕ある制限が、pichamber で使えます。',
  },
  ko: {
    ...
    'settings.integrations.thirdParty.info': '프로바이더 플러그인을 설치한 뒤 구독을 설정하면 pichamber에서 사용할 수 있습니다.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '이 프로바이더를 설정하기 전에 pi를 다시 시작하세요.',
    'settings.integrations.thirdParty.status.registryUnavailable': '지금은 npm을 확인할 수 없습니다.',
    'settings.integrations.thirdParty.status.providerUnavailable': '프로바이더를 아직 사용할 수 없습니다. pi를 다시 시작한 후 재시도하세요.',
    'settings.integrations.thirdParty.dialog.remove.title': '통합 제거',
    'settings.integrations.thirdParty.dialog.remove.description': '사용자 전체 pi 구성에서 {name}을(를) 제거할까요? pi가 새로 고쳐진 후 프로바이더가 더 이상 로드되지 않습니다.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '변경 사항을 적용하려면 pi를 다시 시작하세요',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': 'Claude Pro/Max 요금제를 사용하세요. API 키와 Claude 앱은 필요 없습니다.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 자체 모델의 넉넉한 한도를 이제 pichamber에서.',
  },
  pl: {
    ...
    'settings.integrations.thirdParty.info': 'Zainstaluj wtyczkę dostawcy, a następnie skonfiguruj subskrypcję, aby pichamber mógł z niej korzystać.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Uruchom ponownie pi przed konfiguracją tego dostawcy.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Nie można teraz sprawdzić npm.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Dostawca nie jest jeszcze dostępny. Uruchom ponownie pi i spróbuj ponownie.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Usuń integrację',
    'settings.integrations.thirdParty.dialog.remove.description': 'Usunąć {name} z globalnej konfiguracji pi? Dostawca przestanie być ładowany po odświeżeniu pi.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Uruchom ponownie pi, aby zastosować zmiany',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Hojne limity wewnętrznych modeli Cursor teraz w pichamber.',
  },
  'pt-BR': {
    ...
    'settings.integrations.thirdParty.info': 'Instale um plugin de provedor e configure sua assinatura para o pichamber poder usá-la.',
    'settings.integrations.thirdParty.actions.install': 'Instalar',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Reinicie o pi antes de configurar este provedor.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Não foi possível verificar o npm agora.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'O provedor ainda não está disponível. Reinicie o pi e tente novamente.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Remover integração',
    'settings.integrations.thirdParty.dialog.remove.description': 'Remover {name} da sua configuração global do pi? O provedor deixará de ser carregado após a atualização do pi.',
    'settings.integrations.thirdParty.toast.installed': '{name} instalado',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Reinicie o pi para que as alterações entrem em vigor',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Os limites generosos dos modelos internos do Cursor, agora no pichamber.',
  },
  uk: {
    ...
    'settings.integrations.thirdParty.info': 'Установіть плагін провайдера, а потім налаштуйте підписку, щоб pichamber міг її використовувати.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Перезапустіть pi перед налаштуванням цього провайдера.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Зараз не вдалося перевірити npm.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Провайдер ще недоступний. Перезапустіть pi й спробуйте знову.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Видалити інтеграцію',
    'settings.integrations.thirdParty.dialog.remove.description': 'Видалити {name} з вашої глобальної конфігурації pi? Після оновлення pi провайдер більше не завантажуватиметься.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Перезапустіть pi, щоб застосувати зміни',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Щедрі ліміти внутрішніх моделей Cursor — тепер в pichamber.',
  },
  'zh-CN': {
    ...
    'settings.integrations.thirdParty.info': '安装提供商插件并设置订阅，以便 pichamber 可以使用它。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '请先重启 pi，再设置此提供商。',
    'settings.integrations.thirdParty.status.registryUnavailable': '当前无法检查 npm。',
    'settings.integrations.thirdParty.status.providerUnavailable': '该提供商尚不可用。请重启 pi 后重试。',
    'settings.integrations.thirdParty.dialog.remove.title': '移除集成',
    'settings.integrations.thirdParty.dialog.remove.description': '要从用户级 pi 配置中移除 {name} 吗？pi 刷新后将不再加载该提供商。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '请重启 pi 以使更改生效',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': '使用 Claude Pro/Max 套餐——无需 API 密钥，也无需 Claude 应用。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 内部模型的充足额度，现已可用于 pichamber。',
  },
  'zh-TW': {
    ...
    'settings.integrations.thirdParty.info': '安裝供應商外掛並設定訂閱，以便 pichamber 可以使用它。',
    ...
    'settings.integrations.thirdParty.status.restartRequired': '請先重新啟動 pi，再設定此供應商。',
    'settings.integrations.thirdParty.status.registryUnavailable': '目前無法檢查 npm。',
    'settings.integrations.thirdParty.status.providerUnavailable': '供應商尚不可用。請重新啟動 pi 後再試一次。',
    'settings.integrations.thirdParty.dialog.remove.title': '移除整合',
    'settings.integrations.thirdParty.dialog.remove.description': '要從使用者層級 pi 設定中移除 {name} 嗎？pi 重新整理後將不再載入此供應商。',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': '請重新啟動 pi 以使變更生效',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    'settings.integrations.thirdParty.opencodeClaude.description': '使用 Claude Pro/Max 方案——無需 API 金鑰，也無需 Claude 應用程式。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor 內部模型的充足額度，現已可用於 pichamber。',
  },
} as const;
