...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj pichamber, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'pichamber został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z pichamber',
  ...
  'mobile.connect.password.placeholder': 'Hasło pichamber',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia pichamber.',
  ...
  'mobile.connect.relay.badge': 'przez pichamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem pichamber.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O pichamber',
  ...
  'chat.emptyState.opencodeUnreachable': 'pi jest nieosiągalny',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'pi uruchomił się ponownie podczas generowania odpowiedzi. Wyślij wiadomość, aby kontynuować.',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia pichamber.',
  ...
  'onboarding.chooser.title': 'Witaj w pichamber',
  ...
  'onboarding.localSetup.title': 'Konfiguracja pi',
  'onboarding.localSetup.description': 'Zainstaluj CLI pi aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę opencode',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj pi za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli pichamber nie wykryje pi automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja pi',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy pi CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki pi:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień pichamber i przeładowuje konfigurację pi.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom pi natywnie.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera pichamber aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer pichamber, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji pichamber. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia pichamber, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj pichamber na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim pichamber. Zweryfikuj czy adres wskazuje na serwer pichamber.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'pi lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić pi CLI lub nie jest zainstalowany. Zainstaluj pi lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia pichamber. Zweryfikuj czy adres wskazuje na serwer pichamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer pichamber pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj pichamber na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'pichamber nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan pichamber, kondycję pi, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja pichamber {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja pi {version}',
  ...
  'commandPalette.item.showOpenCodeStatus': 'Pokaż status pi',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer pichamber, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest pichamber, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest pichamber. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do pichamber — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami pichamber',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber potrzebuje dostępu do tego folderu.',
  ...
  'header.actions.openAppMenu': 'Menu pichamber',
  'header.actions.openAppMenuAria': 'Otwórz menu pichamber',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po pichamber.',
  ...
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę pi.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz pichamber z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj pichamber',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja pichamber',
  ...
  'updateDialog.header.updating': 'Aktualizowanie pichamber...',
  ...
  'opencodeUpdate.toast.actions.reload': 'Przeładuj pi',
  'opencodeUpdate.toast.upgrading.title': 'Aktualizowanie pi...',
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw pichamber otwarte.',
  'opencodeUpdate.toast.updated.title': 'pi zaktualizowany',
  ...
  'opencodeUpdate.toast.failed.title': 'Nie udało się zaktualizować pi',
  'opencodeUpdate.toast.failed.description': 'Aktualizacja pi nie powiodła się.',
  'opencodeUpdate.toast.reload.message': 'Ponowne uruchamianie pi...',
  ...
  'onboarding.localSetup.intro': 'pi to serce pichamber — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na pi',
