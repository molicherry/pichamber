...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'pi Go usage tracking',
  'settings.providers.page.openCodeGo.description': 'Connect the pi Go dashboard to show rolling, weekly, and monthly quota.',
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. pichamber never scans browser cookie storage.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Could not validate pi Go credentials.',
  'settings.providers.page.openCodeGo.valid': 'pi Go credentials are valid.',
  'settings.providers.page.openCodeGo.invalid': 'pi Go credentials are invalid or expired.',
  'settings.providers.page.openCodeGo.deleted': 'pi Go credentials deleted.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Could not delete pi Go credentials.',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload pi',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart pi and reload its configuration.',
  'settings.view.actions.applyAndRestartOpenCode': 'Apply & Restart',
  'settings.view.actions.applyAndRestartOpenCodeTooltipSingle': 'Apply 1 pending configuration change and restart pi.',
  'settings.view.actions.applyAndRestartOpenCodeTooltipPlural': 'Apply {count} pending configuration changes and restart pi.',
  'settings.view.pendingRestart.applying': 'Restarting...',
  'settings.view.pendingRestart.applied': 'pi restarted with pending configuration changes.',
  'settings.view.pendingRestart.applyFailed': 'Failed to apply configuration changes.',
  'settings.view.pendingRestart.manualRestartRequired': 'Saved on disk. Restart your connected pi server to apply the changes.',
  'settings.view.pendingRestart.saved': 'Saved. Restart pi to apply.',
  'settings.view.pendingRestart.confirm.title': 'Apply & restart?',
  'settings.view.pendingRestart.confirm.description': 'Restarting pi will stop any running chats. Your saved configuration changes will take effect after the restart.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the pichamber app on your other device.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port pichamber uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected pi server to apply the changes.',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': 'Permissions saved — restart the pi server to apply',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. pi also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.skills.location.option.userOpencode.label': 'User / pi',
  'settings.skills.location.option.userOpencode.description': 'Global pi config location',
  'settings.skills.location.option.projectOpencode.label': 'Project / pi',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. pichamber will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start pichamber at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start pichamber when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show pichamber in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show pichamber in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, pichamber does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close pichamber to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps pichamber running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while pichamber is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while pichamber is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'pichamber asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'pichamber Tools',
  ...
  'settings.openchamber.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after pi restarts.',
  'settings.openchamber.tools.field.agentWebTool': 'pichamber Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the pichamber Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in pichamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after pi restarts.',
  ...
  'settings.openchamber.opencodeCli.field.binaryPath': 'pi Binary Path',
  'settings.openchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openchamber.opencodeCli.field.showUpdateNotifications': 'Show pi update notifications',
  'settings.openchamber.opencodeCli.field.showUpdateNotificationsAria': 'Show pi update notifications',
  'settings.openchamber.opencodeCli.actions.browseAria': 'Browse for pi binary path',
  'settings.openchamber.opencodeCli.actions.browse': 'Browse',
  'settings.openchamber.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'Restarting pi…',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open pichamber there.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'pichamber runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode pichamber needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this pichamber directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote pichamber. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote pichamber to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote pichamber UI. pichamber sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the pichamber server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing pichamber',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating pichamber',
  ...
  'settings.providers.sidebar.empty.description': 'Check your pi configuration',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check your pi configuration',
  ...
  'settings.providers.page.custom.description': 'Add a provider with a base URL, credentials, model list, and supported API protocol. Saved to pi config for use in chat.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in pi auth, not by pichamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to pi and never stored by pichamber.',
  ...
  'settings.mcp.page.status.description.awaitingRestart': 'This server is saved but not applied yet. Use Apply & Restart to load it into pi — connect and authorization become available after that.',
  'settings.mcp.page.status.description.connected': 'Connected and ready for pi to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'pi could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Waiting for pi to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use pi\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let pi infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'pi will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but pi reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but pi reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. pi reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. pi reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but pi reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'pi reload failed after saving the browser callback URL',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'pi agent default',
  ...
  'settings.github.page.flow.title': 'Authorize pichamber',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if pichamber auth is removed',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the pichamber server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the pichamber server (Kokoro, English). The model downloads automatically; no API key needed.',
