...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'pi Go 사용량 추적',
  'settings.providers.page.openCodeGo.description': 'pi Go 대시보드를 연결하여 롤링, 주간 및 월간 할당량을 표시합니다.',
  ...
  'settings.providers.page.openCodeGo.help': '대시보드 URL에서 워크스페이스 ID를, 브라우저 개발자 도구에서 auth 쿠키를 복사하세요. pichamber는 브라우저 쿠키 저장소를 검색하지 않습니다.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'pi Go 인증 정보를 검증할 수 없습니다.',
  'settings.providers.page.openCodeGo.valid': 'pi Go 인증 정보가 유효합니다.',
  'settings.providers.page.openCodeGo.invalid': 'pi Go 인증 정보가 유효하지 않거나 만료되었습니다.',
  'settings.providers.page.openCodeGo.deleted': 'pi Go 인증 정보를 삭제했습니다.',
  'settings.providers.page.openCodeGo.deleteFailed': 'pi Go 인증 정보를 삭제할 수 없습니다.',
  ...
  'settings.window.description': 'pichamber 설정 창입니다.',
  ...
  'settings.view.actions.reloadOpenCode': 'pi 다시 로드',
  'settings.view.actions.reloadOpenCodeTooltip': 'pi를 재시작하고 설정을 다시 불러옵니다.',

  'settings.view.actions.applyAndRestartOpenCode': '적용하고 다시 시작',
  'settings.view.actions.applyAndRestartOpenCodeTooltipSingle': '보류 중인 구성 변경 1개를 적용하고 pi를 다시 시작합니다.',
  'settings.view.actions.applyAndRestartOpenCodeTooltipPlural': '보류 중인 구성 변경 {count}개를 적용하고 pi를 다시 시작합니다.',
  'settings.view.pendingRestart.applying': '다시 시작하는 중…',
  'settings.view.pendingRestart.applied': '보류 중인 구성 변경으로 pi를 다시 시작했습니다.',
  'settings.view.pendingRestart.applyFailed': '구성 변경을 적용하지 못했습니다.',
  'settings.view.pendingRestart.manualRestartRequired': '디스크에 저장되었습니다. 연결된 pi 서버를 다시 시작하여 변경 사항을 적용하세요.',
  'settings.view.pendingRestart.saved': '저장되었습니다. 적용하려면 pi를 다시 시작하세요.',

  'settings.view.pendingRestart.confirm.title': '적용하고 다시 시작할까요?',
  'settings.view.pendingRestart.confirm.description': 'pi를 다시 시작하면 실행 중인 채팅이 중지됩니다. 저장된 구성 변경 사항은 다시 시작 후 적용됩니다.',
  ...
  'settings.page.appearance.description': 'pichamber의 모양과 느낌을 맞춤 설정하세요.',
  ...
  'settings.remoteInstances.direct.title': '다른 pichamber 서버',
  'settings.remoteInstances.direct.description': '이 앱이 전환할 수 있는 서버입니다. 다른 서버의 페어링 링크를 가져오거나 주소로 추가하세요.',
  'settings.remoteInstances.direct.addDialog.description': 'URL로 다른 pichamber 서버를 추가합니다. 서버가 이미 실행 중이고 연결 토큰이 있을 때 사용하세요.',
  ...
  'settings.remoteInstances.direct.import.description': '다른 pichamber 서버에서 만든 연결 링크를 붙여넣으세요.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': '잘못된 pichamber 연결 링크입니다.',
  ...
  'settings.remoteInstances.clientAuth.description': 'pichamber Desktop이 이 서버에 연결할 수 있도록 안전한 링크나 토큰을 만듭니다.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '다른 기기의 pichamber 앱으로 스캔하세요. 일회용이며 만료됩니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '집과 밖 어디서나 작동합니다. 밖에서는 종단간 암호화 터널인 pichamber Private Relay를 통해 연결됩니다. 설정이 필요 없습니다.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '다른 기기의 pichamber 앱으로 이 QR 코드를 스캔하세요.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'pichamber가 서버를 대신 시작할지, 이미 실행 중인 서버에 연결할지 선택하세요.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'pichamber가 원격 머신에서 사용할 포트. 비워 두면 자동으로 선택됩니다.',
  ...
  'settings.openchamber.about.title': 'pichamber 정보',
  'settings.openchamber.about.field.version': '버전',
  'settings.openchamber.about.field.openCodeVersion': 'pi 버전',
  ...
  'settings.agents.page.toast.savedManualRestart': '디스크에 저장되었습니다. 변경 사항을 적용하려면 연결된 pi 서버를 다시 시작하세요.',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': '권한이 저장되었습니다 — 적용하려면 pi 서버를 재시작하세요',
  ...
  'settings.behavior.page.warning.description': '여기에서 변경한 내용은 {path}를 업데이트합니다. 프로젝트 수준의 AGENTS.md가 있으면 pi도 함께 포함합니다.',
  ...
  'settings.behavior.page.systemPromptOptimization.enableAria': 'pi 시스템 프롬프트 크기 최적화',
  'settings.behavior.page.systemPromptOptimization.info': 'build 및 plan 에이전트의 시스템 프롬프트를 약 40% 줄입니다. 다른 에이전트는 변경되지 않습니다. build 또는 plan을 재정의하는 사용자 지정 정의가 제거될 수 있으므로 이러한 워크플로에서는 활성화하지 마세요. pi를 다시 시작하면 변경 사항이 적용됩니다.',
  'settings.behavior.page.systemPromptOptimization.restarting': '시스템 프롬프트 최적화를 적용하기 위해 pi를 다시 시작하는 중…',
  ...
  'settings.skills.location.option.userOpencode.label': '사용자 / pi',
  'settings.skills.location.option.userOpencode.description': '전역 pi 설정 위치',
  'settings.skills.location.option.projectOpencode.label': '프로젝트 / pi',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Git 저장소를 새 카탈로그 소스로 추가합니다. pichamber는 다음을 포함하는 폴더를 스캔합니다:',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 pichamber 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 pichamber 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'macOS 메뉴 막대에 pichamber 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '메뉴 막대에 pichamber 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '앱을 다시 시작해야 합니다. 끄면 pichamber가 메뉴 막대 항목을 만들지 않으며 세션, 승인 및 사용량 업데이트도 실행하지 않습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'pichamber를 시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 닫아도 pichamber가 시스템 트레이에서 계속 실행됩니다. 최소화하면 창은 작업 표시줄에 남습니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'pichamber가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'pichamber가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'pichamber는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.openchamber.tools.title': 'pichamber 도구',
  ...
  'settings.openchamber.tools.field.agentControlToolInfo': '에이전트가 채팅에서 작업을 오케스트레이션할 수 있습니다. 세션과 worktree 생성, 다른 에이전트에게 프롬프트 위임, 예약 작업 관리가 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. pi를 다시 시작하면 적용됩니다.',
  'settings.openchamber.tools.field.agentWebTool': 'pichamber Web 도구',
  'settings.openchamber.tools.field.agentWebToolAria': 'pichamber Web 도구 활성화',
  'settings.openchamber.tools.field.agentWebToolInfo': '에이전트가 pichamber 브라우저 패널에서 페이지를 확인하고 조작할 수 있습니다. URL 열기, 내용 읽기, 클릭, 입력, 스크롤, 모바일과 데스크톱 레이아웃 전환이 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. pi를 다시 시작하면 적용됩니다.',
  ...
  'settings.openchamber.tools.field.agentMemoryToolInfo': '에이전트가 배운 내용을 세션 간에 유지하도록 합니다. 저장소는 두 개로, 사용자에 대한 사실과 각 프로젝트에 대한 사실입니다. 세션에는 저장된 제목이 전달되어 관련 항목을 에이전트가 읽을 수 있습니다. 끄면 도구와 메모리 탭, 세션 색인이 모두 사라집니다. pi를 다시 시작한 뒤 적용됩니다.',
  'settings.openchamber.opencodeCli.tooltipPrefix': '선택적 절대 경로:',
  'settings.openchamber.opencodeCli.tooltipSuffix': 'binary.',
  'settings.openchamber.opencodeCli.field.binaryPath': 'pi binary 경로',
  'settings.openchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openchamber.opencodeCli.field.showUpdateNotifications': 'pi 업데이트 알림 표시',
  'settings.openchamber.opencodeCli.field.showUpdateNotificationsAria': 'pi 업데이트 알림 표시',
  'settings.openchamber.opencodeCli.actions.browseAria': 'pi binary 경로 찾아보기',
  'settings.openchamber.opencodeCli.actions.browse': '찾아보기',
  'settings.openchamber.opencodeCli.actions.saveAndReload': '저장 + 다시 로드',
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'pi 다시 시작 중…',
  ...
  'settings.remoteInstances.page.description': 'SSH로 다른 컴퓨터에 연결하고 그곳에서 pichamber를 엽니다.',
  ...
  'settings.remoteInstances.page.section.remoteServer': '원격 컴퓨터의 pichamber',
  'settings.remoteInstances.page.section.remoteServerDescription': 'SSH 연결 후 pichamber를 어떻게 실행할지 선택하세요.',
  'settings.remoteInstances.page.section.mainTunnel': '이 컴퓨터에서의 접근',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'pichamber는 원격 머신에서 실행됩니다. 이 설정은 SSH 터널을 통해 그곳으로 연결되는 이 컴퓨터의 주소만 제어합니다.',
  'settings.remoteInstances.page.section.authentication': '인증',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH와 원격 pichamber UI를 위한 인증 정보입니다.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '이 앱이 대신 시작할 때 pichamber를 원격 컴퓨터에 배치하는 방법입니다.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '먼저 원격 포트를 지정하세요. "이미 실행 중" 모드에서는 서버가 어떤 포트에서 대기하는지 pichamber가 알아야 합니다.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '원격 머신 네트워크의 다른 기기가 SSH 터널 없이 이 pichamber를 직접 열 수 있게 합니다. UI 비밀번호가 필요합니다.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '그 네트워크의 누구나 원격 pichamber에 접근할 수 있습니다. 아래 UI 비밀번호만이 이를 보호합니다.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '먼저 UI 비밀번호를 설정하세요. 없으면 원격 pichamber가 그 네트워크의 모든 기기에 열리게 됩니다.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '원격 pichamber 화면을 보호할 비밀번호. pichamber가 대신 시작하는 서버에 이 값을 설정합니다.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '원격 머신에서 이미 실행 중인 pichamber 서버에 로그인할 때 쓰는 비밀번호.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'pichamber 설치 중',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'pichamber 업데이트 중',
  ...
  'settings.providers.sidebar.empty.description': 'pi 설정을 확인하세요',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'pi 설정을 확인하세요',
  ...
  'settings.providers.page.custom.description': '기본 URL, 자격 증명, 모델 목록 및 지원되는 API 프로토콜로 제공자를 추가합니다. 채팅에 사용할 수 있도록 pi 설정에 저장됩니다.',
  ...
  'settings.providers.page.custom.field.providerID.info': '소문자, 숫자, 하이픈, 밑줄. pi 제공자 ID로 사용됩니다.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'pichamber가 아니라 pi 인증에 저장됩니다. 환경 변수에서 읽으려면 {env:VAR_NAME}을 사용하세요.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 pi로 직접 전송되며 pichamber에 저장되지 않습니다.',
  ...
  'settings.mcp.page.status.description.awaitingRestart': '이 서버는 저장되었지만 아직 적용되지 않았습니다. Apply & Restart를 사용해 pi에 불러오면 연결과 인증을 사용할 수 있습니다.',
  'settings.mcp.page.status.description.connected': '연결되었습니다. pi가 도구와 리소스를 찾을 준비가 됐습니다.',
  'settings.mcp.page.status.description.failedDefault': 'pi가 이 MCP 서버에 연결할 수 없습니다.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'pi가 브라우저 인증 flow 완료를 감지하기를 기다리는 중...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'pi의 기본 MCP 시간 초과를 사용하려면 비워 두세요.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'pi가 MCP 서버에서 OAuth 설정을 추론하도록 하려면 이 필드를 비워 두세요.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'pi를 다시 로드해야 합니다.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP 서버가 생성되었지만 pi 다시 로드에 실패했습니다.',
  'settings.mcp.page.toast.savedReloadFailed': '저장했지만 pi 다시 로드에 실패했습니다.',
  'settings.mcp.page.toast.retryRefreshHint': '이 서버에 권한을 부여하기 전에 새로고침을 다시 시도하거나 Settings를 다시 여세요.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP 서버가 생성되었습니다. pi 다시 로드 중…',
  'settings.mcp.page.toast.savedReloading': '저장되었습니다. pi 다시 로드 중…',
  'settings.mcp.page.toast.saveFailed': '저장하지 못했습니다',
  'settings.mcp.page.toast.unexpectedError': '오류가 발생했습니다',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}"이(가) 삭제되었지만 pi 다시 로드에 실패했습니다',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': '브라우저 callback URL 저장 후 pi 다시 로드에 실패했습니다',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'pi 에이전트 기본값',
  ...
  'settings.github.page.flow.title': 'pichamber 권한 부여',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'pichamber 인증이 제거된 경우 대체로 사용 가능',
  ...
  'settings.notifications.page.testNotification.body': 'pichamber의 테스트 알림입니다.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'pichamber 서버에서 로컬로 변환합니다. 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
  'settings.voice.page.tooltip.localTts': 'pichamber 서버에서 로컬로 음성을 합성합니다(Kokoro, 영어). 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
