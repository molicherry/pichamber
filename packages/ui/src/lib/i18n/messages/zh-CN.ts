...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 pichamber 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'pichamber 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 pichamber',
  ...
  'mobile.connect.password.placeholder': 'pichamber 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 pichamber 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 pichamber',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 pichamber 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 pichamber 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 pichamber 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 pichamber 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 pichamber 中编辑。请下载后使用其他应用打开。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber 需要访问此文件夹。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 pichamber 状态、pi 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 pichamber',
  ...
  'header.actions.openAppMenu': 'pichamber 菜单',
  'header.actions.openAppMenuAria': '打开 pichamber 菜单',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接 pi',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'pi 在回复仍在生成时重启了。发送一条消息以继续。',
  ...
  'commandPalette.item.showOpenCodeStatus': '显示 pi 状态',
  ...
  'openCodeStatusDialog.title': 'pi 状态',
  'openCodeStatusDialog.description': '查看当前 pi 状态与诊断信息。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 pichamber，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 pichamber',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 pichamber 服务器之间切换',
  ...
  'multiRun.window.description': 'pichamber 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 pichamber',
  ...
  'onboarding.localSetup.title': '设置 pi',
  'onboarding.localSetup.description': '安装 pi CLI 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 pi 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 pi。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 pichamber 未自动检测到 pi，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'pi 是 pichamber 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'pi 文档',
  'onboarding.localSetup.docs.default': 'pi 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 pi CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 pi',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 pi CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 pichamber 设置并重新加载 pi 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 pi。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 pichamber 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 pichamber 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 pichamber。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 pichamber，但与此应用版本不兼容。请更新服务器上的 pichamber 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 pichamber。请确认地址是否指向 pichamber 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 pi 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLI 无法启动或未安装。请安装 pi，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 pichamber。请确认地址是否指向 pichamber 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 pichamber 服务器与此应用版本不兼容。请更新服务器上的 pichamber 后重试。',
  ...
  'startup.initRecovery.description': 'pichamber 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.actions.reload': '重载 pi',
  'opencodeUpdate.toast.upgrading.title': '正在更新 pi...',
  'opencodeUpdate.toast.upgrading.description': '请保持 pichamber 打开。',
  ...
  'opencodeUpdate.toast.failed.title': '无法更新 pi',
  'opencodeUpdate.toast.failed.description': 'pi 升级失败。',
  'opencodeUpdate.toast.reload.message': '正在重启 pi...',
  ...
  'openChamberLogo.aria.logo': 'pichamber 标志',
