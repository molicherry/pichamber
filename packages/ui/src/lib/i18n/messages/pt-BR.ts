...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o pichamber para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "pichamber instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao pichamber",
  ...
  "mobile.connect.password.placeholder": "Senha do pichamber",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do pichamber.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor pichamber.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o pichamber",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor pichamber ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o pichamber está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o pichamber. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao pichamber — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no pichamber. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "pichamber precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do pichamber {version}",
  "aboutDialog.openCodeVersionLabel": "Versão do pi {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do pichamber, a integridade do pi, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo pichamber com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do pichamber",
  "header.actions.openAppMenuAria": "Abrir menu do pichamber",
  ...
  "chat.emptyState.opencodeUnreachable": "pi não está acessível",
  ...
  "chat.toast.opencodeRestartInterrupted.description": "O pi foi reiniciado enquanto uma resposta ainda estava em andamento. Envie uma mensagem para continuar.",
  ...
  "commandPalette.item.showOpenCodeStatus": "Mostrar status do pi",
  ...
  "openCodeStatusDialog.description": "Inspecione o status atual do pi e os diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o pichamber de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do pichamber",
  ...
  "multiRun.window.description": "Janela do pichamber Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao pichamber",
  ...
  "onboarding.localSetup.title": "Configuração do pi",
  "onboarding.localSetup.description": "Instale a CLI do pi para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável de opencode",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do pi ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o pi com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o pichamber não detectar o pi automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "pi é o coração do pichamber. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do pi",
  "onboarding.localSetup.docs.default": "Documentação do pi",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do pi está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando pi",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do pi:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do pichamber e recarregue configurações do pi.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o pi nativamente.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do pichamber para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor pichamber ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do pichamber. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando pichamber, mas não é compatível com esta versão do app. Atualize o pichamber no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando pichamber. Verifique se o endereço aponta para um servidor pichamber.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "pi Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do pi não pôde ser iniciada ou não está instalada. Instale o pi ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando pichamber. Verifique se o endereço aponta para um servidor pichamber.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor pichamber em \"{host}\" não é compatível com esta versão do app. Atualize o pichamber no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O pichamber não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando pichamber...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do pichamber disponível",
  ...
  "opencodeUpdate.toast.available.title": "Atualização do pi",
  ...
  "opencodeUpdate.toast.actions.reload": "Recarregar pi",
  "opencodeUpdate.toast.upgrading.title": "Atualizando pi...",
  "opencodeUpdate.toast.upgrading.description": "Mantenha o pichamber aberto.",
  "opencodeUpdate.toast.updated.title": "pi atualizado",
  ...
  "opencodeUpdate.toast.failed.title": "Não foi possível atualizar o pi",
  "opencodeUpdate.toast.failed.description": "A atualização do pi falhou.",
  ...
  "openChamberLogo.aria.logo": "Logo do pichamber",
