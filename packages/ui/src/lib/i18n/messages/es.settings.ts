...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'Seguimiento de uso de pi Go',
  'settings.providers.page.openCodeGo.description': 'Conecta el panel de pi Go para ver las cuotas móvil, semanal y mensual.',
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. pichamber nunca examina las cookies del navegador.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'No se pudieron validar las credenciales de pi Go.',
  'settings.providers.page.openCodeGo.valid': 'Las credenciales de pi Go son válidas.',
  'settings.providers.page.openCodeGo.invalid': 'Las credenciales de pi Go no son válidas o han caducado.',
  'settings.providers.page.openCodeGo.deleted': 'Credenciales de pi Go eliminadas.',
  'settings.providers.page.openCodeGo.deleteFailed': 'No se pudieron eliminar las credenciales de pi Go.',
  ...
  "settings.window.description": "Ventana de configuración de pichamber.",
  ...
  "settings.view.actions.reloadOpenCode": "Recargar pi",
  "settings.view.actions.reloadOpenCodeTooltip": "Restablecer pi y recargar su configuración.",

  "settings.view.actions.applyAndRestartOpenCode": "Aplicar y reiniciar",
  "settings.view.actions.applyAndRestartOpenCodeTooltipSingle": "Aplicar 1 cambio de configuración pendiente y reiniciar pi.",
  "settings.view.actions.applyAndRestartOpenCodeTooltipPlural": "Aplicar {count} cambios de configuración pendientes y reiniciar pi.",
  "settings.view.pendingRestart.applying": "Reiniciando…",
  "settings.view.pendingRestart.applied": "pi se reinició con los cambios de configuración pendientes.",
  "settings.view.pendingRestart.applyFailed": "No se pudieron aplicar los cambios de configuración.",
  "settings.view.pendingRestart.manualRestartRequired": "Guardado en disco. Reinicia el servidor pi conectado para aplicar los cambios.",
  "settings.view.pendingRestart.saved": "Guardado. Reinicia pi para aplicar.",

  "settings.view.pendingRestart.confirm.title": "¿Aplicar y reiniciar?",
  "settings.view.pendingRestart.confirm.description": "Reiniciar pi detendrá cualquier chat en ejecución. Los cambios de configuración guardados se aplicarán después del reinicio.",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de pichamber.",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de pichamber",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de pichamber por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.direct.import.description": "Pega un enlace de conexión de otro servidor de pichamber.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Enlace de conexión de pichamber no válido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que pichamber Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de pichamber en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por pichamber Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de pichamber en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Elige si pichamber debe iniciar el servidor por ti o conectarse a uno que ya está en marcha.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Puerto que pichamber usa en la máquina remota. Déjalo vacío para elegir uno automáticamente.",
  ...
  "settings.openchamber.about.title": "Acerca de pichamber",
  "settings.openchamber.about.field.version": "Versión",
  "settings.openchamber.about.field.openCodeVersion": "Versión de pi",
  ...
  "settings.agents.page.toast.savedManualRestart": "Guardado en disco. Reinicia tu servidor pi conectado para aplicar los cambios.",
  ...
  "settings.agents.page.permissionsEditor.toast.savedRestartRequired": "Permisos guardados: reinicia el servidor de pi para aplicarlos",
  ...
  "settings.behavior.page.warning.description": "Los cambios realizados aquí actualizan {path}. pi también incluye cualquier AGENTS.md a nivel de proyecto cuando existe.",
  ...
  "settings.behavior.page.systemPromptOptimization.enableAria": "Optimizar el tamaño del prompt del sistema de pi",
  "settings.behavior.page.systemPromptOptimization.info": "Reduce el prompt del sistema aproximadamente un 40 % para los agentes build y plan. Los demás agentes no cambian. Puede eliminar definiciones personalizadas que sobrescriban build o plan, así que no lo actives en esos flujos de trabajo. El cambio se aplica al reiniciar pi.",
  "settings.behavior.page.systemPromptOptimization.restarting": "Reiniciando pi para aplicar la optimización del prompt del sistema…",
  ...
  "settings.skills.location.option.userOpencode.label": "Usuario / pi",
  "settings.skills.location.option.userOpencode.description": "Ubicación global de la configuración de pi",
  "settings.skills.location.option.projectOpencode.label": "Proyecto / pi",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. pichamber escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar pichamber al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar pichamber al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar pichamber en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar pichamber en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, pichamber no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar pichamber a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene pichamber en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras pichamber está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras pichamber está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "pichamber la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.opencodeCli.title": "CLI de pi",
  "settings.openchamber.tools.title": "Herramientas de pichamber",
  ...
  "settings.openchamber.tools.field.agentControlToolInfo": "Permite que los agentes orquesten tu trabajo desde el chat: crear sesiones y worktrees, delegar prompts a otros agentes y gestionar tareas programadas. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar pi.",
  "settings.openchamber.tools.field.agentWebTool": "Herramienta pichamber Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta pichamber Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de pichamber e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar pi.",
  ...
  "settings.openchamber.opencodeCli.field.binaryPath": "Ruta del ejecutable de pi",
  "settings.openchamber.opencodeCli.field.binaryPathPlaceholder": "/Users/you/.bun/bin/opencode",
  "settings.openchamber.opencodeCli.field.showUpdateNotifications": "Mostrar notificaciones de actualización de pi",
  "settings.openchamber.opencodeCli.field.showUpdateNotificationsAria": "Mostrar notificaciones de actualización de pi",
  "settings.openchamber.opencodeCli.actions.browseAria": "Buscar ruta del ejecutable de pi",
  ...
  "settings.openchamber.opencodeCli.actions.restartingOpenCode": "Reiniciando pi…",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre pichamber allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "pichamber en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse pichamber después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso desde este equipo",
  "settings.remoteInstances.page.section.mainTunnelDescription": "pichamber se ejecuta en la máquina remota. Estos ajustes solo controlan la dirección de este equipo que lleva hasta ella por el túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de pichamber remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse pichamber en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Primero indica un puerto remoto. En el modo «Ya está en ejecución», pichamber necesita saber en qué puerto escucha el servidor.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir también que otros dispositivos de la red de la máquina remota abran este pichamber directamente, sin el túnel SSH. Requiere contraseña de la interfaz.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Cualquiera en esa red puede llegar al pichamber remoto. Solo lo protege la contraseña de la interfaz de abajo.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Define primero una contraseña de la interfaz. Sin ella, el pichamber remoto quedaría abierto a todos los dispositivos de esa red.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Contraseña con la que se protegerá la interfaz remota de pichamber. pichamber la aplica al servidor que inicia por ti.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Contraseña del servidor pichamber que ya se ejecuta en la máquina remota, usada para iniciar sesión.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando pichamber",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando pichamber",
  ...
  "settings.providers.sidebar.empty.description": "Revisa tu configuración de pi",
  ...
  "settings.providers.page.empty.checkOpenCodeConfiguration": "Revisa tu configuración de pi",
  ...
  "settings.providers.page.custom.description": "Añade un proveedor con URL base, credenciales, lista de modelos y un protocolo de API compatible. Se guarda en la configuración de pi para usarlo en el chat.",
  ...
  "settings.providers.page.custom.field.providerID.info": "Minúsculas, números, guiones y guiones bajos. Se usa como ID de proveedor de pi.",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de pi, no en pichamber. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a pi y nunca se almacenan en pichamber.",
  ...
  "settings.mcp.page.status.description.awaitingRestart": "Este servidor está guardado pero aún no aplicado. Usa «Apply & Restart» para cargarlo en pi; después estarán disponibles la conexión y la autorización.",
  "settings.mcp.page.status.description.connected": "Conectado y listo para que pi descubra herramientas y recursos.",
  "settings.mcp.page.status.description.failedDefault": "pi no pudo alcanzar este servidor MCP.",
  ...
  "settings.mcp.page.auth.waitingForOpenCode": "Esperando a que pi observe el flujo de autorización completado por el navegador...",
  ...
  "settings.mcp.page.advanced.timeoutHint": "Dejar en blanco para usar el tiempo de espera predeterminado de pi para MCP.",
  ...
  "settings.mcp.page.advanced.oauthHint": "Dejar estos campos en blanco para que pi infiera automáticamente la configuración de OAuth del servidor MCP.",
  ...
  "settings.mcp.page.deleteDialog.descriptionSuffix": "pi necesitará recargar.",
  ...
  "settings.mcp.page.toast.serverCreatedReloadFailed": "Servidor MCP creado, pero pi no pudo recargar.",
  "settings.mcp.page.toast.savedReloadFailed": "Guardado, pero pi no pudo recargar.",
  ...
  "settings.mcp.page.toast.serverCreatedReloading": "Servidor MCP creado. pi recargando…",
  "settings.mcp.page.toast.savedReloading": "Guardado. pi recargando…",
  "settings.mcp.page.toast.saveFailed": "No se pudo guardar",
  "settings.mcp.page.toast.unexpectedError": "Ocurrió un error",
  "settings.mcp.page.toast.serverDeletedReloadFailed": "\"{name}\" eliminado, pero pi no pudo recargar",
  ...
  "settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave": "No se pudo recargar pi después de guardar la URL de callback del navegador",
  ...
  "settings.openchamber.defaults.summaryOpenCodeDefault": "Agente pi por defecto",
  ...
  "settings.github.page.flow.title": "Autorizar pichamber",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de pichamber",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de pichamber.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de pichamber. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis local en el servidor de pichamber (Kokoro, inglés). El modelo se descarga automáticamente; no se necesita clave de API.",
