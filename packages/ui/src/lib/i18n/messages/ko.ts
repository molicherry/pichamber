...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 pichamber를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'pichamber가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'pichamber에 연결',
  ...
  'mobile.connect.password.placeholder': 'pichamber 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 pichamber 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'pichamber Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 pichamber 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'pichamber 정보',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 pichamber 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) pichamber가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 pichamber가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 pichamber에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 pichamber에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.openChamberVersionLabel': 'pichamber 버전 {version}',
  'aboutDialog.openCodeVersionLabel': 'pi 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'pichamber 상태, pi 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 pichamber를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'pichamber 메뉴',
  'header.actions.openAppMenuAria': 'pichamber 메뉴 열기',
  ...
  'chat.toast.opencodeRestartInterrupted.description': '응답이 진행 중인 동안 pi가 다시 시작되었습니다. 계속하려면 메시지를 보내세요.',
  ...
  'commandPalette.item.showOpenCodeStatus': 'pi 상태 표시',
  ...
  'openCodeStatusDialog.title': 'pi 상태',
  'openCodeStatusDialog.description': '현재 pi 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 pichamber를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'pichamber 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 pichamber 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'pichamber 멀티런 창.',
  ...
  'onboarding.chooser.title': 'pichamber에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'pi 설정',
  'onboarding.localSetup.description': '계속하려면 pi CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'opencode 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 pi를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'pichamber가 pi를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'pi는 pichamber의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'pi 문서',
  'onboarding.localSetup.docs.default': 'pi 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'pi CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'pi 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? pi CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'pichamber 설정에 저장하고 pi 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 pi를 네이티브로 설치하고 실행하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 pichamber 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 pichamber 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 pichamber 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 pichamber가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 pichamber를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 pichamber가 실행 중이 아닙니다. 주소가 pichamber 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 pi를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLI를 시작할 수 없거나 설치되어 있지 않습니다. pi를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 pichamber가 실행 중이 아닙니다. 주소가 pichamber 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 pichamber 서버가 이 앱 버전과 호환되지 않습니다. 서버의 pichamber를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'pichamber 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'pichamber 업데이트 중…',
  ...
  'mobileUpdate.toast.available.title': 'pichamber 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.actions.reload': 'pi 다시 로드',
  'opencodeUpdate.toast.upgrading.title': 'pi 업데이트 중...',
  'opencodeUpdate.toast.upgrading.description': 'pichamber를 열어 두세요.',
  'opencodeUpdate.toast.updated.title': 'pi 업데이트 완료',
  ...
  'opencodeUpdate.toast.failed.title': 'pi를 업데이트할 수 없음',
  'opencodeUpdate.toast.failed.description': 'pi 업그레이드에 실패했습니다.',
  'opencodeUpdate.toast.reload.message': 'pi 다시 시작 중...',
  ...
  'openChamberLogo.aria.logo': 'pichamber 로고',
