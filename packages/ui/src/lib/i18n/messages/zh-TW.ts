...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 pichamber 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'pichamber 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 pichamber',
  ...
  'mobile.connect.password.placeholder': 'pichamber 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 pichamber 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 pichamber Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 pichamber 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 pichamber。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 pichamber，但與此應用程式版本不相容。請更新伺服器上的 pichamber 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 pichamber 伺服器與此應用程式版本不相容。請更新伺服器上的 pichamber 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 pichamber',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 pichamber 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 pichamber 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 pichamber 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 pichamber 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 pichamber 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber 需要存取此資料夾。',
  ...
  'aboutDialog.openChamberVersionLabel': 'pichamber 版本 {version}',
  'aboutDialog.openCodeVersionLabel': 'pi 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 pichamber 狀態、pi 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 pichamber',
  ...
  'header.actions.openAppMenu': 'pichamber 選單',
  'header.actions.openAppMenuAria': '開啟 pichamber 選單',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線 pi',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'pi 在回覆仍在產生時重新啟動。傳送訊息以繼續。',
  ...
  'commandPalette.item.showOpenCodeStatus': '顯示 pi 狀態',
  ...
  'openCodeStatusDialog.title': 'pi 狀態',
  'openCodeStatusDialog.description': '查看目前 pi 狀態與診斷資訊。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 pichamber，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 pichamber',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 pichamber 伺服器之間切換',
  ...
  'multiRun.window.description': 'pichamber 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 pichamber',
  ...
  'onboarding.localSetup.title': '設定 pi',
  'onboarding.localSetup.description': '安裝 pi CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 pi 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 pi。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 pichamber 未自動偵測到 pi，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'pi 是 pichamber 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'pi 文件',
  'onboarding.localSetup.docs.default': 'pi 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 pi CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 pi',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 pi CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 pichamber 設定並重新載入 pi 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 pi。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 pichamber 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 pichamber 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 pichamber。請確認位址是否指向 pichamber 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 pi 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLI 無法啟動或未安裝。請安裝 pi，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 pichamber。請確認位址是否指向 pichamber 伺服器。',
  ...
  'startup.initRecovery.description': 'pichamber 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 pichamber...',
  ...
  'opencodeUpdate.toast.actions.reload': '重新載入 pi',
  'opencodeUpdate.toast.upgrading.title': '正在更新 pi...',
  'opencodeUpdate.toast.upgrading.description': '請保持 pichamber 開啟。',
  'opencodeUpdate.toast.updated.title': 'pi 已更新',
  'opencodeUpdate.toast.updated.description': '更新已安裝。',
  'opencodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'opencodeUpdate.toast.failed.title': '無法更新 pi',
  'opencodeUpdate.toast.failed.description': 'pi 升級失敗。',
  'opencodeUpdate.toast.reload.message': '正在重新啟動 pi...',
  ...
  'openChamberLogo.aria.logo': 'pichamber 標誌',
