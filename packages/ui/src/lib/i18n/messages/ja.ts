...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'pichamberをインストールしてすぐにアクセス',
  'pwa.installPrompt.action': 'インストール',
  'pwa.installPrompt.dismiss': '閉じる',
  'pwa.installPrompt.started': 'インストールを開始しました',
  'pwa.installPrompt.installed': 'pichamberをインストールしました',
  ...
  'mobile.connect.welcome.title': 'pichamber に接続',
  ...
  'mobile.connect.password.placeholder': 'pichamber のパスワード',
  ...
  'mobile.connect.relay.badge': 'pichamber Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その pichamber サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは pichamber の接続コードではありません。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'pichamberについて',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している pichamber サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は pichamber が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは pichamber を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページはpichamberへの完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、pichamberでは編集できません。別のアプリで開くにはダウンロードしてください。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'pichamber がこのフォルダにアクセスする必要があります。',
  ...
  'aboutDialog.openChamberVersionLabel': 'pichamber バージョン {version}',
  'aboutDialog.openCodeVersionLabel': 'pi バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'pichamberの状態、piの状態、ディレクトリ、プロジェクトが含まれます。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってpichamberを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'pichamberメニュー',
  'header.actions.openAppMenuAria': 'pichamberメニューを開く',
  ...
  'chat.emptyState.opencodeUnreachable': 'piに接続できません',
  ...
  'chat.toast.opencodeRestartInterrupted.description': '応答の生成中に pi が再起動しました。続行するにはメッセージを送信してください。',
  ...
  'commandPalette.item.showOpenCodeStatus': 'pi のステータスを表示',
  ...
  'openCodeStatusDialog.description': '現在のpiステータスと診断情報を確認します。',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから pichamber を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'pichamberのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのpichamberサーバーを切り替えます',
  ...
  'multiRun.window.description': 'pichamberマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'pichamberへようこそ',
  ...
  'onboarding.localSetup.title': 'piのセットアップ',
  'onboarding.localSetup.description': 'pi CLIをインストールして続行します。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'opencodeバイナリを選択',
  'onboarding.localSetup.errors.cliNotReady': 'pi CLIの準備ができていません。インストールが完了していることを確認してもう一度お試しください。',
  'onboarding.localSetup.errors.detectionFailed': '検出に失敗しました',
  'onboarding.localSetup.windows.title': 'Windowsセットアップ',
  'onboarding.localSetup.windows.stepInstallWsl': '以下のコマンドでpiをインストールします。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'pichamberがpiを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'piはpichamberの中核です — インストールして開始しましょう。',
  'onboarding.localSetup.docs.windows': 'piドキュメント',
  'onboarding.localSetup.docs.default': 'piドキュメント',
  'onboarding.localSetup.actions.checking': '確認中…',
  'onboarding.localSetup.actions.checkNow': '今すぐ確認',
  'onboarding.localSetup.helper.checkAndContinue': 'クリックしてpi CLIが利用可能か確認します。成功すると自動的にメイン画面に進みます。',
  'onboarding.localSetup.status.watching': 'piを待機中',
  'onboarding.localSetup.field.alreadyInstalled': 'すでにインストール済みですか？pi CLIのパスを設定:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'pichamber設定に保存し、pi設定を再読み込みします。',
  'onboarding.localSetup.remotePreference': 'リモートサーバーを使用しますか？',
  'onboarding.localSetup.actions.connectRemoteServer': 'リモートサーバーに接続 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windowsでは、piをネイティブでインストールして実行します。',
  ...
  'onboarding.remoteConnection.description': '接続するpichamberサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがpichamberサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのpichamberを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはpichamberを実行していますが、このアプリバージョンと互換性がありません。サーバーのpichamberを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、pichamberを実行していません。アドレスがpichamberサーバーを指していることを確認してください。',
  'onboarding.remoteConnection.probe.unreachableMessage': 'サーバーに到達できません。ネットワーク接続を確認し、サーバーアドレスを確認してください。',
  'onboarding.desktopRecovery.localUnavailable.title': 'ローカルpiが利用できません',
  'onboarding.desktopRecovery.localUnavailable.description': 'pi CLIを起動できないか、インストールされていません。piをインストールするか、代わりにリモートサーバーに接続してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはpichamberを実行していません。アドレスがpichamberサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のpichamberサーバーはこのアプリバージョンと互換性がありません。サーバーのpichamberを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'pichamberが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'pichamberを更新中...',
  ...
  'mobileUpdate.toast.available.title': 'pichamberの更新があります',
  ...
  'opencodeUpdate.toast.available.title': 'pi更新',
  ...
  'opencodeUpdate.toast.actions.reload': 'piを再読み込み',
  'opencodeUpdate.toast.upgrading.title': 'piを更新中...',
  'opencodeUpdate.toast.upgrading.description': 'pichamberを開いたままにしてください。',
  'opencodeUpdate.toast.updated.title': 'piを更新しました',
  ...
  'opencodeUpdate.toast.failed.title': 'piを更新できませんでした',
  'opencodeUpdate.toast.failed.description': 'piのアップグレードに失敗しました。',
  'opencodeUpdate.toast.reload.message': 'piを再起動中...',
  ...
  'openChamberLogo.aria.logo': 'pichamberロゴ',
